      ...
      class Hal
        class HasManyTest < Minitest::Test
          ...
          def test_includes_linked_comments
            @adapter = ActiveModel::Serializer::Adapter::Hal.new(@serializer, include: 'comments')
            expected = [{
              id: "1",
              type: "comments",
              attributes: {
          ...
          def test_limit_fields_of_linked_comments
            @adapter = ActiveModel::Serializer::Adapter::Hal.new(@serializer, include: 'comments', fields: {comment: [:id]})
            expected = [{
              id: "1",
              type: "comments",
              relationships: {
